...
## ⚡ ПРАВИЛО: при любом изменении цен или описаний туров
1. **Сначала обновить `~/AI_Projects/tours-data.md`** — единый справочник цен
2. Затем обновить все остальные файлы согласно списку ниже
